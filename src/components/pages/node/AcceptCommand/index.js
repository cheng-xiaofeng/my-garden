    ...
    return (
      <div>
        ...
        <div className='articleConent'>
          <p>原文地址: <a target="_blank"  rel="noopener noreferrer" href="https://nodejs.dev/learn/accept-input-from-the-command-line-in-nodejs">https://nodejs.dev/learn/accept-input-from-the-command-line-in-nodejs</a></p>
          <p>怎么使node.js CLI程序具有交互性</p>
          <p>node.js 7提供了一个<a target="_blank"  rel="noopener noreferrer" href="https://nodejs.org/api/readline.html">readline</a>模块可以这么做:从一个可读的数据流,
          ...
          <p>使用<a target="_blank"  rel="noopener noreferrer" href="https://www.npmjs.com/package/readline-sync">readline-sync</a>包,API跟这个很相似,开箱即用</p>
          <p>一个更完整更纯粹的解决方法是<a target="_blank"  rel="noopener noreferrer" href="https://github.com/SBoudrias/Inquirer.js">Inquirer.js package</a></p>
