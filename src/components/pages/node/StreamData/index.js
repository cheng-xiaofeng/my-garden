    ...
    return (
      <div>
        ...
        <div className='articleConent'>
          <p>原文地址: <a target="_blank"  rel="noopener noreferrer" href="https://nodejs.dev/learn/nodejs-streams">https://nodejs.dev/learn/nodejs-streams</a></p>
          <h2>什么是数据流?</h2>
          ...
          <p>node的<a target="_blank"  rel="noopener noreferrer" href="https://nodejs.org/api/stream.html">stream 模块</a>提供了数据流API的基础,
            所有的数据流都是<a target="_blank"  rel="noopener noreferrer" href="https://nodejs.org/api/events.html#events_class_eventemitter">EventEmitter的实例</a>
          </p>
          <h2>为什么选择数据流</h2>
          ...
          <h2>怎么创建可读数据流</h2>
          <p>可以从<a target="_blank"  rel="noopener noreferrer" href="https://nodejs.org/api/stream.html">stream模块</a>得到可读的数据流,初始化后执行readable._read方法:</p>
          <p>首先创建一个数据流对象:</p>
          ...
          <p>然后执行write方法</p>
          <CodeEditor codeContent={codeAll.code10} height="100px"/>
          <p>现在可以匹配一个可读的数据流</p>
          ...
          <h2>怎么给可写的数据流发送数据</h2>
          <p>使用数据流的write方法:</p>
          <CodeEditor codeContent={codeAll.code14} height="60px"/>
