    ...
    return (
      <div>
        ...
        <div className='articleConent'>
          <p>原文地址: <a target="_blank"  rel="noopener noreferrer" href="https://nodejs.dev/learn/the-npx-nodejs-package-runner">https://nodejs.dev/learn/the-npx-nodejs-package-runner</a></p>
          <p>2017年7月,npm 5.2版本发布了很强大的npx命令</p>
          <p>注意:不想安装npm,可以单独安装<a target="_blank"  rel="noopener noreferrer" href="https://www.npmjs.com/package/npx">npx</a></p>
          ...
          <p>使用@符指定版本,组合<a target="_blank"  rel="noopener noreferrer" href="https://www.npmjs.com/package/node">npm包</a></p>
